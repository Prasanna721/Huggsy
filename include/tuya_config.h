...
#define TUYA_OPENSDK_UUID    "uuid5cac335fba2e46ca"             // Please change the correct uuid
#define TUYA_OPENSDK_AUTHKEY "HDKu02JKynz67QExAYMLsMUARRjkEiD5" // Please change the correct authkey
